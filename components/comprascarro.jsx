    ...
    <div className={` flex flex-col md:flex-row `} >
      <ul className={` w-full md:w-4/6`} >
        {items.map((item) => {
          ...
          return (
            <li className={`relative p-4 rounded-r-3xl border-t-2 border-black border-opacity-5 bg-gradient-to-b from-[rgb(217,239,252,0.5)] to-[rgb(217,239,252,0.2)] shadow-md shadow-[rgba(0,0,0,0.5)] mb-4 sm:mb-5 md:mb-6 lg:mb-7 `} key={item.id}>
