      ...
      <section className={` relative max-w-7xl mx-auto flex flex-col-reverse md:flex-row gap-10 md:gap-6 py-10 md:py-0`}>
        <div className={` w-full md:w-1/2 flex flex-col items-center justify-center `}>
          <p className={` `}>
            ...
            <Link className={` inline-block relative h-12 w-12 rounded-full bg-white bg-opacity-60 m-4 `} href=''><img className={`m-auto inset-0 w-5 h-auto object-bottom absolute opacity-60 `} src={facebookIcon.src} alt='' /></Link>
            <Link className={` inline-block relative h-12 w-12 rounded-full bg-white bg-opacity-60 m-4 `} href=''><img className={`m-auto inset-0 w-6 h-auto object-bottom absolute opacity-60 `} src={linkedInIcon.src} alt='' /></Link>
            <Link className={` inline-block relative h-12 w-12 rounded-full bg-white bg-opacity-60 m-4 `} href=''><img className={`m-auto inset-0 w-8 h-auto object-bottom absolute opacity-60 `} src={youtubeIcon.src} alt='' /></Link>
          </p>
          <p className={` text-white text-opacity-60 text-2xl font-LexendDeca font-extralight mt-4`}>
            © 2024 LATASOFT Chile
          </p>
        </div>
        <div className={` w-full md:w-1/2 my-0 md:my-8 font-Roboto font-normal text-md text-left sm:text-md md:text-lg text-white text-opacity-60 `}>
