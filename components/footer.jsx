...
const Footer = () => {
  return (
    <footer className={` relative w-full bg-[#5a5246] text-center`}>
      <div className={` absolute top-0 left-0 w-full h-full bg-repeat `} style={{ backgroundImage: `url(images/noise.png)` }} />
      <div className={`  absolute top-0 left-0 w-full h-5    bg-gradient-to-b from-[rgba(0,0,0,0.4)] to-transparent `} />
      <div className={`  absolute top-0 left-0 w-full h-full bg-gradient-to-b from-[rgba(0,0,0,0.4)] to-transparent `} />
