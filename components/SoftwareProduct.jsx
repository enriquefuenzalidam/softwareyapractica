...
const SoftwareProduct = () => {
  ...
  return (
    <div className={` relative rounded-sm mx-auto p-3 sm:p-4 md:p-6 lg:p-8 max-w-7xl rounded-l-lg rounded-r-3xl bg-gradient-to-b from-[rgba(217,239,252,0.7)] to-[rgba(217,239,252,0.3)] shadow-md shadow-[rgba(0,0,0,0.5)]  `}>
